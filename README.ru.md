...
* **консилиумом** — у каждой такой ячейки свой порядок запуска: **«Только я»**
  ...
  Имена, заведённые попыткой, сервер после неё снимает; изменения существующих
  объектов и файлов остаются общими. Пометка о проверке доходит только до автора
