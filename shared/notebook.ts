 ...
 *
 * Общими остаются файлы на диске, состояние модулей (`np.random.seed`,
 * `pd.set_option`) и то, что скопировать не вышло — слишком большое или не
 * того типа; об этом попытка читает строкой в собственном выводе. Одна строка
 * на всех местах, где об этом говорят: подсказка ручки studentRun, полоса
 * консилиума, README.
 */
