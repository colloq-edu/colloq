 ...
 *
 * До сих пор папка была плоской: `safeName` в workspace.ts отвергала всё, где
 ...
 *
 * Ничего не чинит и ничего не переименовывает. Тихо поправленное имя — это
 * файл, который человек потом не найдёт там, где положил.
 */
 ...
 * и у имён участников, — и он записан в workspace.ts над исходной проверкой.
 */
