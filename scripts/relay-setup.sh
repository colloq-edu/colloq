...
# студент, открывший привычный адрес занятия до начала пары, получал бы не
...
#
# Запускать: scripts/relay-setup.sh root@203.0.113.10
# Только страница: scripts/relay-setup.sh --page root@203.0.113.10
set -euo pipefail
...
HOST=${1:?укажите куда ставить: scripts/relay-setup.sh root@203.0.113.10}
